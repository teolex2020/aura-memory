...
- If the Bun/ESM spike exposes an incompatibility, document and implement the narrowest fallback that still preserves the Phase 7 stdio contract, rather than continuing with an assumed-good scaffold.
