...
- [x] 06.3-06-PLAN.md — ConceptEngine P1+P2: Cluster guards + surface alignment (per-ns cap, 5-dim tiebreak) (TDD)
...
- [x] 06.3-08-PLAN.md — CausalEngine P1+P2: 20+ field scoring + evidence gates + corpus fingerprint (TDD)
...
- [x] 06.3-10-PLAN.md — PolicyEngine P2: 4-dim scoring + suppression + recommendation templates + surface alignment (TDD)
...
- [x] 07-05-PLAN.md — Explainability + correction facades: explain_recall/record/bundle, correction log, review queues, suggested corrections
