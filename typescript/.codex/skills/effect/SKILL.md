---
name: effect
description: (Most important) Work with Effect v4 / effect-smol TypeScript code in this repo
---
...
- Use `it.effect(...)` or `it.layer(_ => _.effect(...))` from `@effect/vitest` for tests that exercise Effect services, layers, runtime context, scoped resources, or platform integrations.
