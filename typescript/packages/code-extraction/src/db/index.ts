...
import { type SqliteDatabase, type SqliteBackend, createDatabase } from './sqlite-adapter';
import * as fs from 'fs';
import * as path from 'path';
import { SchemaVersion } from '../types';
import { runMigrations, getCurrentVersion, CURRENT_SCHEMA_VERSION } from './migrations';

export { type SqliteDatabase, type SqliteBackend } from './sqlite-adapter';
...
export class DatabaseConnection {
  ...
  static initialize(dbPath: string): DatabaseConnection {
    ...
    const schemaPath = new URL('schema.sql', import.meta.dirname);
