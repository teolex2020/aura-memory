...
- Define the Rust MCP binary contract inside the harness/docs:
  - how the binary is built in test environments
  - how an already-built binary is discovered on Windows/Bun workspaces
  - what exact skip condition is allowed when Cargo/Rust MCP startup is unavailable
